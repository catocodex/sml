...
Route::group(['middleware' => ['installed', 'checkBackend', 'auth', 'activity'], 'prefix' => 'dashboard'], function () {
    ...
    Route::get('/instructor/profile/{id}', 'Instructor\InstructorController@instructorEdit')->name('instructors.adminEdit');
    Route::post('/instructor/profile/update/{id}', 'Instructor\InstructorController@instructorUpdate')->name('instructors.adminUpdate')->middleware('demo');
...
Route::group(['middleware' => 'installed'], function () {
    Route::get('color/setup', 'ColorController@index')->name('color.setup');
