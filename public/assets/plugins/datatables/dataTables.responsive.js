            ...
            return function(b, d, e) {
                if (d) c("div.dtr-modal-content").empty().append(e());
                    ...
                    var f = function() {
                        ...
                        g = c('<div class="dtr-modal"/>').append(c('<div class="dtr-modal-display"/>').append(c('<div class="dtr-modal-content"/>').append(e())).append(c('<div class="dtr-modal-close">&times;</div>').on('click',function() {
                            f()
                        }))).append(c('<div class="dtr-modal-background"/>').on('click',function() {
                            f()
                        })).appendTo("body");
