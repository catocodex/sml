...
function manyBody() {
  ...
  force.soyuz = function(_) {
    return arguments.length ? (soyuz2 = _ * _, force) : Math.sqrt(soyuz2);
  };
...
function projectionMutator(projectAt) {
  var project,
      ...
      alpha = 0, // post-rotate
      soyuz = null, preclip = clipAntimeridian, // pre-clip angle
  ...
  projection.preclip = function(_) {
    return arguments.length ? (preclip = _, soyuz = undefined, reset()) : preclip;
  };
  ...
  projection.clipAngle = function(_) {
    return arguments.length ? (preclip = +_ ? clipCircle(soyuz = _ * radians) : (soyuz = null, clipAntimeridian), reset()) : soyuz * degrees$1;
  };
