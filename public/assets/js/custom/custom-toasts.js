...
$(document).ready(function() {
    ...
    $("#simple-toasts-btn").on('click',function() {
    ...
    $("#top-right-toasts-btn").on('click',function() {
    ...
    $("#bottom-right-toasts-btn").on('click',function() {
    ...
    $("#bottom-left-toasts-btn").on('click',function() {
    ...
    $("#top-left-toasts-btn").on('click',function() {
    ...
    $("#center-toasts-btn").on('click',function() {
