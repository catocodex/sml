                ...
                return (
                    ...
                    (n.createObjectURL = function (a) {
                        ...
                        return (
                            ...
                            a instanceof d
                                ? ((b = "data:" + c), "base64" === a.encoding ? b + ";base64," + a.data : "URI" === a.encoding ? b + "," + decodeURIComponent(a.data) : o ? b + ";base64," + o(a.data) : b + "," + encodeURIComponent(a.data))
                                : l
                                ? l.call(k, a)
                                : void 0
                        );
            ...
            return (
                ...
                (function (b) {
                    ...
                    var h = {
                        ...
                        splitOffDOMTree: function (a, b, c) {
                            for (var d = b, e = null, f = !c; d !== a; ) {
                                ...
                                for (e && (f ? i.appendChild(e) : (g = e)), e = i; j; ) {
                                    var k = j.nextSibling;
                                    j === d
                                        ? (j.hasChildNodes() ? (j = j.cloneNode(!1)) : j.parentNode.removeChild(j), j.textContent && e.appendChild(j), (j = f ? k : null))
                                        : (j.parentNode.removeChild(j), (j.hasChildNodes() || j.textContent) && e.appendChild(j), (j = k));
                                }
                        ...
                        moveTextRangeIntoElement: function (a, b, c) {
                            ...
                            return (
                                g === a ? (g.parentNode.removeChild(g), n.appendChild(g)) : n.appendChild(h.splitOffDOMTree(g, a)),
                                k.forEach(function (a) {
                                    a.parentNode.removeChild(a), n.appendChild(a);
                                }),
                                i === b ? (i.parentNode.removeChild(i), n.appendChild(i)) : n.appendChild(h.splitOffDOMTree(i, b, !0)),
                                c.appendChild(n),
                ...
                (function () {
                    ...
                    var c = {
                                ...
                                for ((d || a.startsWithImage || "undefined" != typeof a.emptyBlocksIndex) && (n = !0); !m && g; )
                                    if (g.nodeType > 3) g = h.pop();
                                        ...
                                        if (3 !== g.nodeType || k) {
                                            ...
                                            (f = i + g.length),
                                                !j && a.start >= i && a.start <= f && (n || a.start < f ? (e.setStart(g, a.start - i), (j = !0)) : (o = g)),
                                                j && a.end >= i && a.end <= f && (a.trailingImageCount ? (k = !0) : (e.setEnd(g, a.end - i), (m = !0))),
                                                (i = f);
                                        m || (g = h.pop());
                                    }
                        ...
                        getSelectedParentElement: function (a) {
                            return a
                                ? this.rangeSelectsSingleNode(a) && 3 !== a.startContainer.childNodes[a.startOffset].nodeType
                ...
                (function () {
                    ...
                    (c.prototype = {
                        ...
                        updateFocus: function (c, d) {
                            ...
                            e !== f && (f && g && (f.removeAttribute("data-medium-focused"), this.triggerCustomEvent("blur", d, f)), e && (e.setAttribute("data-medium-focused", !0), this.triggerCustomEvent("focus", d, e))),
                        ...
                        handleKeydown: function (b) {
                            return (
                                ...
                                a.util.isKey(b, a.util.keyCode.SPACE)
                                    ? this.triggerCustomEvent("editableKeydownSpace", b, b.currentTarget)
                                    : a.util.isKey(b, a.util.keyCode.ENTER) || (b.ctrlKey && a.util.isKey(b, a.util.keyCode.M))
                                    ? this.triggerCustomEvent("editableKeydownEnter", b, b.currentTarget)
                                    : a.util.isKey(b, a.util.keyCode.TAB)
                                    ? this.triggerCustomEvent("editableKeydownTab", b, b.currentTarget)
                                    : a.util.isKey(b, [a.util.keyCode.DELETE, a.util.keyCode.BACKSPACE])
                                    ? this.triggerCustomEvent("editableKeydownDelete", b, b.currentTarget)
                                    : void 0
                            );
                        },
                    }),
                    ...
                    var b = a.Extension.extend({
                        ...
                        createButton: function () {
                            ...
                            return (
                                ...
                                c && (a.setAttribute("title", c), a.setAttribute("aria-label", c)),
                                this.attrs &&
                        ...
                        isAlreadyApplied: function (a) {
                            ...
                            return this.knownState === !1 || this.knownState === !0
                                ? this.knownState
                                : (e && e.length > 0 && (d = -1 !== e.indexOf(a.nodeName.toLowerCase())),
                                  !d &&
                                      this.style &&
                ...
                (function () {
                    a.extensions.button.prototype.defaults = {
                        ...
                        superscript: { name: "superscript", action: "superscript", aria: "superscript", tagNames: ["sup"], contentDefault: "<b>x<sup>1</sup></b>", contentFA: '<i class="fa fa-superscript"></i>' },
                ...
                (function () {
                    var b = a.extensions.form.extend({
                        ...
                        handleClick: function (b) {
                            ...
                            return "a" === c.startContainer.nodeName.toLowerCase() || "a" === c.endContainer.nodeName.toLowerCase() || a.util.getClosestTag(a.selection.getSelectedParentElement(c), "a")
                        ...
                        getTemplate: function () {
                            ...
                            return (
                                a.push('<a href="#" class="medium-editor-toolbar-save">', "fontawesome" === this.getEditorOption("buttonLabels") ? '<i class="fa fa-check"></i>' : this.formSaveLabel, "</a>"),
                                ...
                                this.customClassOption &&
                                    a.push('<div class="medium-editor-toolbar-form-row">', '<input type="checkbox" class="medium-editor-toolbar-anchor-button">', "<label>", this.customClassOptionText, "</label>", "</div>"),
                                a.join("")
                            );
                        },
                        isDisplayed: function () {
                ...
                (function () {
                    var b = a.Extension.extend({
                        ...
                        showPreview: function (a) {
                            return this.anchorPreview.classList.contains("medium-editor-anchor-preview-active") || a.getAttribute("data-disable-preview")
                                ? !0
                                : (this.previewValueSelector &&
                                      ((this.anchorPreview.querySelector(this.previewValueSelector).textContent = a.attributes.href.value), (this.anchorPreview.querySelector(this.previewValueSelector).href = a.attributes.href.value)),
                        ...
                        positionPreview: function (a) {
                            ...
                            var b,
                                ...
                                m = ["absolute", "fixed"].indexOf(window.getComputedStyle(l).getPropertyValue("position")) > -1,
                                n = {};
                            ...
                            o && ((j = o.diffLeft), (k = o.diffTop)),
                                ...
                                b > d
                                    ? ((this.anchorPreview.style.left = c + b + "px"), (this.anchorPreview.style.right = "initial"))
                                    : b > g - d
                                    ? ((this.anchorPreview.style.left = "auto"), (this.anchorPreview.style.right = 0))
                                    : ((this.anchorPreview.style.left = c + d + "px"), (this.anchorPreview.style.right = "initial"));
                        },
                        ...
                        handleClick: function (a) {
                            ...
                            b &&
                                ...
                                this.base.delay(
                                    function () {
                                        if (c) {
                                            var a = { value: c.attributes.href.value, target: c.getAttribute("target"), buttonClass: c.getAttribute("class") };
                                            b.showForm(a), (c = null);
                                        }
                                    }.bind(this)
                                )),
                    ...
                    var h = a.Extension.extend({
                        ...
                        onKeypress: function (b) {
                            this.disableEventHandling ||
                                (a.util.isKey(b, [a.util.keyCode.SPACE, a.util.keyCode.ENTER]) &&
                        ...
                        performLinking: function (b) {
                            ...
                            return this.base.events.updateInput(b, { target: b, currentTarget: b }), d;
                        },
                            ...
                            handleDrop: function (a) {
                                ...
                                (c.start = c.end),
                                    ...
                                    a.dataTransfer.files &&
                                        Array.prototype.slice.call(a.dataTransfer.files).forEach(function (a) {
                            ...
                            if (this.keys[c]) {
                                ...
                                this.keys[c].forEach(function (a) {
                                    a.meta !== d ||
                                        ...
                                        (b.preventDefault(), b.stopPropagation(), "function" == typeof a.command ? a.command.apply(this) : !1 !== a.command && this.execAction(a.command));
                                }, this);
                            }
                        },
                    });
                ...
                (function () {
                    var b = a.extensions.form.extend({
                        ...
                        handleFontChange: function () {
                            ...
                            "" === a ? this.clearFontName() : this.execAction("fontName", { value: a });
                        },
                        handleFormClick: function (a) {
                            a.stopPropagation();
                        },
                ...
                (function () {
                    var b = a.extensions.form.extend({
                        ...
                        handleSliderChange: function () {
                            ...
                            "4" === a ? this.clearFontSize() : this.execAction("fontSize", { value: a });
                        },
                        handleFormClick: function (a) {
                            a.stopPropagation();
                        },
                        ...
                        h = a.Extension.extend({
                            ...
                            handlePasteBinPaste: function (a) {
                                ...
                                return !this.cleanPastedHTML || d
                                    ? (a.preventDefault(), this.removePasteBin(), this.doPaste(d, e, g), void this.trigger("editablePaste", { currentTarget: g, target: g }, g))
                                    : void setTimeout(
                                          function () {
                                              this.cleanPastedHTML && (d = this.getPasteBinHtml()), this.removePasteBin(), this.doPaste(d, e, g), this.trigger("editablePaste", { currentTarget: g, target: g }, g);
                                          }.bind(this),
                                          0
                                      );
                            },
                            ...
                            createPasteBin: function (b) {
                                ...
                                (f = b),
                                    h && ((c = h.getClientRects()), (i += c.length ? c[0].top : void 0 !== h.startContainer.getBoundingClientRect ? h.startContainer.getBoundingClientRect().top : h.getBoundingClientRect().top)),
                                    (e = h);
                            ...
                            pasteHTML: function (b, c) {
                                c = a.util.defaults({}, c, { cleanAttrs: this.cleanAttrs, cleanTags: this.cleanTags, unwrapTags: this.unwrapTags });
                                var d,
                                    e,
                                    f,
                                    g,
                                    h = this.document.createDocumentFragment();
                                for (h.appendChild(this.document.createElement("body")), g = h.querySelector("body"), g.innerHTML = b, this.cleanupSpans(g), d = g.querySelectorAll("*"), f = 0; f < d.length; f += 1)
                                    (e = d[f]),
                            ...
                            filterLineBreak: function (a) {
                                this.isCommonBlock(a.previousElementSibling)
                                    ...
                                    : !this.isCommonBlock(a.parentNode) || (a.parentNode.firstChild !== a && a.parentNode.lastChild !== a)
                                    ? a.parentNode && 1 === a.parentNode.childElementCount && "" === a.parentNode.textContent && this.removeWithParent(a)
                                    : this.removeWithParent(a);
                            },
                        ...
                        showPlaceholder: function (b) {
                            b &&
                                (a.util.isFF && 0 === b.childNodes.length
                                    ? (b.classList.add("medium-editor-placeholder-relative"), b.classList.remove("medium-editor-placeholder"))
                                    : (b.classList.add("medium-editor-placeholder"), b.classList.remove("medium-editor-placeholder-relative")));
                        },
                    ...
                    var b = a.Extension.extend({
                        ...
                        createToolbarButtons: function () {
                            ...
                            return (
                                ...
                                this.buttons.forEach(function (d) {
                                    "string" == typeof d ? ((f = d), (g = null)) : ((f = d.name), (g = d)),
                                        (e = this.base.addBuiltInExtension(f, g)),
                                        e && "function" == typeof e.getButton && ((c = e.getButton(this.base)), (b = this.document.createElement("li")), a.util.isElement(c) ? b.appendChild(c) : (b.innerHTML = c), h.appendChild(b));
                                }, this),
                                (d = h.querySelectorAll("button")),
                                d.length > 0 && (d[0].classList.add(this.firstButtonClass), d[d.length - 1].classList.add(this.lastButtonClass)),
                                h
                            );
                        },
                        destroy: function () {
                        ...
                        checkState: function () {
                            if (!this.base.preventSelectionUpdates) {
                                ...
                                return !b || -1 === this.getEditorElements().indexOf(b) || b.getAttribute("data-disable-toolbar")
                                    ? this.hideToolbar()
                                    : this.updateOnEmptySelection && this["static"]
                                    ? this.showAndUpdateToolbar()
                                    : !a.selection.selectionContainsContent(this.document) || (this.allowMultiParagraphSelection === !1 && this.multipleBlockElementsSelected())
                                    ? this.hideToolbar()
                            ...
                            var b,
                                ...
                                f = function (a) {
                                    "function" == typeof a.checkState
                                        ? a.checkState(b)
                                        : "function" == typeof a.isActive && "function" == typeof a.isAlreadyApplied && "function" == typeof a.setActive && !a.isActive() && a.isAlreadyApplied(b) && a.setActive();
                                };
                            if (
                                e &&
                                (this.forEachExtension(function (a) {
                        ...
                        setToolbarPosition: function () {
                            ...
                            return a
                                ? void (
                                      ...
                                      (this.showToolbar(), this.relativeContainer || (this["static"] ? this.positionStaticToolbar(a) : this.positionToolbar(b)), this.trigger("positionedToolbar", {}, this.base.getFocusedElement()))
                                  )
                                : this;
                        },
                        positionStaticToolbar: function (a) {
                            ...
                            var b,
                                c = (this.document.documentElement && this.document.documentElement.scrollTop) || this.document.body.scrollTop,
                            ...
                            switch (
                                (this.sticky
                                    ? c > g + a.offsetHeight - i - this.stickyTopOffset
                                        ? ((e.style.top = g + a.offsetHeight - i + "px"), e.classList.remove("medium-editor-sticky-toolbar"))
                                        : c > g - i - this.stickyTopOffset
                                        ? (e.classList.add("medium-editor-sticky-toolbar"), (e.style.top = this.stickyTopOffset + "px"))
                                        : (e.classList.remove("medium-editor-sticky-toolbar"), (e.style.top = g - i + "px"))
                                    : (e.style.top = g - i + "px"),
                                this.align)
                            ) {
                                case "left":
                        ...
                        positionToolbar: function (a) {
                            ...
                            (!c || (0 === c.height && 0 === c.width && b.startContainer === b.endContainer)) &&
                                (c = 1 === b.startContainer.nodeType && b.startContainer.querySelector("img") ? b.startContainer.querySelector("img").getBoundingClientRect() : b.startContainer.getBoundingClientRect());
                            var d,
                                e,
                                ...
                                n = ["absolute", "fixed"].indexOf(window.getComputedStyle(m).getPropertyValue("position")) > -1,
                                o = {},
                                p = {};
                            n
                                ...
                                (o.top += c.top - h),
                                c.top < k
                                    ? (g.classList.add("medium-toolbar-arrow-over"), g.classList.remove("medium-toolbar-arrow-under"), (o.top += k + c.height - this.diffTop))
                                    : (g.classList.add("medium-toolbar-arrow-under"), g.classList.remove("medium-toolbar-arrow-over"), (o.top += this.diffTop)),
                                j > d ? ((o.left = l + j), (o.right = "initial")) : j > f - d ? ((o.left = "auto"), (o.right = 0)) : ((o.left = l + d), (o.right = "initial")),
                ...
                (function () {
                    ...
                    function c(b, c) {
                        if (this.options.disableReturn || c.getAttribute("data-disable-return")) b.preventDefault();
                            ...
                            ((d && "" === d.textContent.trim() && "li" !== d.nodeName.toLowerCase()) ||
                                (d.previousElementSibling && "br" !== d.previousElementSibling.nodeName.toLowerCase() && "" === d.previousElementSibling.textContent.trim())) &&
                                b.preventDefault();
                        }
                    }
                    function d(b) {
                        ...
                        "pre" === d && (b.preventDefault(), a.util.insertHTMLCommand(this.options.ownerDocument, "    ")),
                            a.util.isListItem(c) && (b.preventDefault(), b.shiftKey ? this.options.ownerDocument.execCommand("outdent", !1, null) : this.options.ownerDocument.execCommand("indent", !1, null));
                    }
                    function e(b) {
                        var c,
                            ...
                            f = /^(\s+|<br\/?>)?$/i,
                            g = /h\d/i;
                        a.util.isKey(b, [a.util.keyCode.BACKSPACE, a.util.keyCode.ENTER]) && d.previousElementSibling && g.test(e) && 0 === a.selection.getCaretOffsets(d).left
                            ? a.util.isKey(b, a.util.keyCode.BACKSPACE) && f.test(d.previousElementSibling.innerHTML)
                                ? (d.previousElementSibling.parentNode.removeChild(d.previousElementSibling), b.preventDefault())
                                : !this.options.disableDoubleReturn &&
                                  a.util.isKey(b, a.util.keyCode.ENTER) &&
                                  ((c = this.options.ownerDocument.createElement("p")), (c.innerHTML = "<br>"), d.previousElementSibling.parentNode.insertBefore(c, d), b.preventDefault())
                            : a.util.isKey(b, a.util.keyCode.DELETE) && d.nextElementSibling && d.previousElementSibling && !g.test(e) && f.test(d.innerHTML) && g.test(d.nextElementSibling.nodeName.toLowerCase())
                            ? (a.selection.moveCursor(this.options.ownerDocument, d.nextElementSibling), d.previousElementSibling.parentNode.removeChild(d), b.preventDefault())
                            ...
                            ? ((c = this.options.ownerDocument.createElement("p")),
                              ...
                              b.preventDefault())
                            : a.util.isKey(b, a.util.keyCode.BACKSPACE) && a.util.getClosestTag(d, "blockquote") !== !1 && 0 === a.selection.getCaretOffsets(d).left
                            ? (b.preventDefault(), a.util.execFormatBlock(this.options.ownerDocument, "p"))
                            : a.util.isKey(b, a.util.keyCode.ENTER) && a.util.getClosestTag(d, "blockquote") !== !1 && 0 === a.selection.getCaretOffsets(d).right
                            ? ((c = this.options.ownerDocument.createElement("p")), (c.innerHTML = "<br>"), d.parentElement.insertBefore(c, d.nextSibling), a.selection.moveCursor(this.options.ownerDocument, c), b.preventDefault())
                            : a.util.isKey(b, a.util.keyCode.BACKSPACE) &&
                              a.util.isMediumEditorElement(d.parentElement) &&
                              !d.previousElementSibling &&
                              d.nextElementSibling &&
                              f.test(d.innerHTML) &&
                              (b.preventDefault(), a.selection.moveCursor(this.options.ownerDocument, d.nextSibling), d.parentElement.removeChild(d));
                    }
                    function f(b) {
                        var c,
                            d = a.selection.getSelectionStart(this.options.ownerDocument);
                        d &&
                            (a.util.isMediumEditorElement(d) && 0 === d.children.length && !a.util.isBlockContainer(d) && this.options.ownerDocument.execCommand("formatBlock", !1, "p"),
                            !a.util.isKey(b, a.util.keyCode.ENTER) ||
                                a.util.isListItem(d) ||
                                a.util.isBlockContainer(d) ||
                                ((c = d.nodeName.toLowerCase()), "a" === c ? this.options.ownerDocument.execCommand("unlink", !1, null) : b.shiftKey || b.ctrlKey || this.options.ownerDocument.execCommand("formatBlock", !1, "p")));
                    }
                    function g(a, b) {
                    ...
                    function j(b, c, d) {
                        var e = [];
                        if ((b || (b = []), "string" == typeof b && (b = c.querySelectorAll(b)), a.util.isElement(b) && (b = [b]), d))
                    ...
                    function m(a, b, c) {
                        var d = { window: c.options.contentWindow, document: c.options.ownerDocument, base: c };
                    ...
                    function v(b, d) {
                        if (!b.getAttribute("data-medium-editor-element")) {
                            "textarea" === b.nodeName.toLowerCase() &&
                                ((b = u.call(this, b)), this.instanceHandleEditableInput || ((this.instanceHandleEditableInput = g.bind(this)), this.subscribe("editableInput", this.instanceHandleEditableInput))),
                                this.options.disableEditing || b.getAttribute("data-disable-editing") || (b.setAttribute("contentEditable", !0), b.setAttribute("spellcheck", this.options.spellcheck)),
                                this.instanceHandleEditableKeydownEnter ||
                                    ((b.getAttribute("data-disable-return") || b.getAttribute("data-disable-double-return")) &&
                                        ((this.instanceHandleEditableKeydownEnter = c.bind(this)), this.subscribe("editableKeydownEnter", this.instanceHandleEditableKeydownEnter))),
                    ...
                    function x() {
                        ...
                        var c = { paste: !0, "anchor-preview": o.call(this), autoLink: q.call(this), keyboardCommands: s.call(this), placeholder: p.call(this) };
                        Object.keys(c).forEach(function (a) {
                            c[a] && this.addBuiltInExtension(a);
                        }, this);
                        var d = this.options.extensions.toolbar;
                        if (!d && n.call(this)) {
                            var e = a.util.extend({}, this.options.toolbar, { allowMultiParagraphSelection: this.options.allowMultiParagraphSelection });
                    ...
                    function A(b) {
                        if (b) {
                            var c,
                                d = Array.prototype.slice.call(b.childNodes).filter(function (a) {
                    ...
                    (a.prototype = {
                        ...
                        serialize: function () {
                            ...
                            for (a = 0; d > a; a += 1) (b = "" !== this.elements[a].id ? this.elements[a].id : "element-" + a), (c[b] = { value: this.elements[a].innerHTML.trim() });
                            return c;
                        },
                        ...
                        execAction: function (b, c) {
                            ...
                            return (
                                (d = f.exec(b)),
                                d ? (this.saveSelection(), this.selectAllContents(), (e = z.call(this, d[1], c)), this.restoreSelection()) : (e = z.call(this, b, c)),
                                ...
                                try {
                                    if ((this.events.disableCustomEvent("editableInput"), b.url && a.util.deprecated(".url option for createLink", ".value", "6.0.0"), (c = b.url || b.value), c && c.trim().length > 0)) {
                                        ...
                                        if (f) {
                                            ...
                                            if (
                                                (3 === k.endContainer.nodeType && 3 !== k.startContainer.nodeType && 0 === k.startOffset && k.startContainer.firstChild === k.endContainer && (l = k.endContainer),
                                                ...
                                                this.execAction("unlink"),
                                                    ...
                                                    d === m
                                                        ? a.selection.select(this.options.ownerDocument, m.firstChild, 0, m.lastChild, 3 === m.lastChild.nodeType ? m.lastChild.nodeValue.length : m.lastChild.childNodes.length)
                                                        : a.selection.select(this.options.ownerDocument, m, 0, m, m.childNodes.length);
                                                var o = this.exportSelection();
                                                (j = a.util.findOrCreateMatchingTextNodes(this.options.ownerDocument, n, { start: g.start - o.start, end: g.end - o.start, editableElementIndex: g.editableElementIndex })),
                                                    0 === j.length && ((n = this.options.ownerDocument.createDocumentFragment()), n.appendChild(l.cloneNode(!0)), (j = [n.firstChild.firstChild, n.firstChild.lastChild])),
                                            ...
                                            this.options.targetBlank || "_blank" === b.target
                                                ? a.util.setTargetBlank(a.selection.getSelectionStart(this.options.ownerDocument), c)
                                                : a.util.removeTargetBlank(a.selection.getSelectionStart(this.options.ownerDocument), c),
                        ...
                        checkContentChanged: function (b) {
                            (b = b || a.selection.getSelectionElement(this.options.contentWindow)), this.events.updateInput(b, { target: b, currentTarget: b });
                        },
                        ...
                        addElements: function (a) {
                            ...
                            return 0 === b.length
                                ...
                                : void b.forEach(function (a) {
                                      (a = v.call(this, a, this.id)), this.elements.push(a), this.trigger("addElement", { target: a, currentTarget: a }, a);
                                  }, this);
                        },
                        removeElements: function (a) {
                            ...
                            this.elements = this.elements.filter(function (a) {
                                return -1 !== c.indexOf(a) ? (this.events.cleanupElement(a), a.getAttribute("medium-editor-textarea-id") && k(a), this.trigger("removeElement", { target: a, currentTarget: a }, a), !1) : !0;
                            }, this);
                        },
                    }),
                ...
                (a.version = a.parseVersionString.call(this, { version: "5.23.3" }.version)),
                a
            );
        })()
    );
