...
@section('title','Zoom Live Class Addon Upload')
@section('parentPageTitle', 'Zoom Live Class Addon Upload')
@section('content')
            ...
            <div class="col-md-12">
                <div class="card m-2">
                    <div class="card-header">
                        <span class="h1 card-title">@translate(Zoom Live Class Addon Upload)</span>
                    </div>
