                  ...
                  <div class="col-lg-6">
                      <div class="login-form">
                        ...
                        @if (env('GOOGLE_CLIENT_ID') != "")
                            <div class="col-6">
                                <div class="form-group">
                                    <a class="theme-btn g-btn w-100 text-center" href="{{ url('/auth/redirect/google') }}">
                        ...
                        @if (env('FACEBOOK_APP_ID') != "")
                            <div class="col-6">
                                <div class="form-group">
                                    <a class="theme-btn f-btn w-100 text-center" href="{{ url('/auth/redirect/facebook') }}">
                                        <i class="fa fa-facebook mr-2"></i>@translate(Facebook)
                                    </a>
                                </div>
                            </div>
                        @endif
