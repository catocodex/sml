            ...
            <div class="card m-2">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('app.update')}}" enctype="multipart/form-data">
                        ...
                        <input type="hidden" placeholder="@translate(Enter the data)" value="{{env('GOOGLE_CALLBACK').'/callback/google'}}"
                               name="GOOGLE_CALLBACK"
                               class="form-control mb-2">



                        <label class="label">@translate(Facebook APP Key) <a href="https://developers.facebook.com/apps/?show_reminder=true" target="_blank"><i class="fa fa-info text-warning"></i></a></label>
                        <input type="hidden" name="types[]" value="FACEBOOK_APP_ID">
                        <input type="text" placeholder="@translate(Enter the data)" value="{{env('FACEBOOK_APP_ID')}}"
                               name="FACEBOOK_APP_ID"
                               class="form-control mb-2">

                        <label class="label">@translate(Facebook App Secret)</label>
                        <input type="hidden" name="types[]" value="FACEBOOK_APP_SECRET">
                        <input type="text" placeholder="@translate(Enter the data)" value="{{env('FACEBOOK_APP_SECRET')}}"
